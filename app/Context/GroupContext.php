...
class GroupContext implements GroupContextContract
{
    ...
    public function hasAccessToGroup(User $user, Group $group): bool
    {
        ...
        return $this->user->belongsToGroup($group) ||
               $group->ancestors()->contains(function ($ancestor) {
                   return $this->user->belongsToGroup($ancestor);
               });
    }
    ...
    public function isAdmin(Group $group): bool
    {
        ...
        return $adminGroups->contains(function ($adminGroup) use ($group) {
            return $adminGroup->is($group) ||
    ...
    public function hasAccessToAdvisor(User $user, User $advisor): bool
    {
        ...
        return $userGroups->contains(function ($group) use ($advisorGroups) {
            return $advisorGroups->contains($group);
        });
    }
}