...
**Beratungswunsch**: @if($advice->type == \App\Enums\AdviceType::Home)Bei Dir Zuhause @elseif($advice->type == \App\Enums::Virtual) Virtuell @else Nur Teilnahme an der Sammelbestellung @endif
