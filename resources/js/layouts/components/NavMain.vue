...
import { SidebarGroup, SidebarGroupLabel, SidebarMenu, SidebarMenuButton, SidebarMenuItem, SidebarMenuSub, SidebarMenuSubButton, SidebarMenuSubItem } from '@/shadcn/components/ui/sidebar';
                ...
                <SidebarMenuItem v-else-if="item.children">
                    ...
                    <SidebarMenuSub>
                        <SidebarMenuSubItem v-for="child in item.children" :key="child.title">
                            <SidebarMenuSubButton v-if="child.href" as-child :is-active="child.href === page.url" class="text-sidebar-accent-foreground">
