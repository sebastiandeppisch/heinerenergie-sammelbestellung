  ...
  <div ref="outer">
    ...
    <div style="margin: 30px 40px 30px 40px">
      ...
      >
        ...
        <DxColumn data-field="status_id" caption="Status">
          <DxLookup
        ...
        <DxColumn data-field="email" caption="TODO mail" />
        <DxColumn data-field="phone" caption="TODO phone" />
        ...
        <DxSummary :recalculate-while-editing="true">
          <DxTotalItem column="firstName" summary-type="count" />
        </DxSummary>
        <DxMasterDetail :enabled="true" template="adviceTemplate" />
        <DxToolbar> </DxToolbar>
        <template #adviceTemplate="{ data }">
          <!-- TODO -->
          <div>{{ data }}</div>
        </template>
        <template #adviceStatusButton>
