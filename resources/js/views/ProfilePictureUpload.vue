    ...
    <div class="widget-container flex-box">
        ...
        <div style="position: relative">
            ...
            <div
                ...
                class="flex-box"
                :class="[r.isDropZoneActive ? 'dx-theme-accent-as-border-color dropzone-active' : 'dx-theme-border-color']"
                :element-attr="{
                    style: 'position: relative;',
                }"
            >
                <img id="dropzone-image" :src="r.imageSource" v-if="r.imageSource !== null" alt="Kein Profilbild" />
