        ...
        <template #item="{ data: item }">
            <div class="flex items-center py-1.5 pl-1">
                ...
                <div class="mr-3 flex flex-shrink-0 items-center">
                    <img v-if="item.logo_path" :src="item.logo_path" :alt="item.name" class="max-h-[2em] w-auto rounded object-contain" />
                ...
                <div class="flex w-full min-w-0 items-center justify-between">
                    ...
                    <span class="ml-4 text-xs whitespace-nowrap text-gray-500">
