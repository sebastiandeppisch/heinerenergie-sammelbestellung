            ...
            <form @submit.prevent="updateField">
                ...
                <div class="form-section">
                    ...
                    <div class="grid gap-2" v-if="supportsPlaceholder">
                        ...
                        <Input id="field_placeholder" v-model="placeholder" placeholder="Platzhaltertext" @input="onValueChanged" />
                    </div>

                    <div class="mt-4 grid gap-2">
                        <Label for="field_help_text">Hilfetext</Label>
                        <Textarea id="field_help_text" v-model="helpText" placeholder="Hilfetext" class="min-h-[60px]" @input="onValueChanged" />
                    </div>

                    <div class="mt-4 grid gap-2" v-if="supportsDefaultValue">
                        <Label for="field_default_value">Standardwert</Label>
                        <Input id="field_default_value" v-model="defaultValue" placeholder="Standardwert" @input="onValueChanged" />
                    </div>
                </div>
                ...
                <div v-if="supportsLengthValidation" class="form-section">
                    ...
                    <div class="grid gap-2">
                        ...
                        <Input id="field_min_length" v-model="minLength" type="number" placeholder="Minimale Länge" min="0" @input="onValueChanged" />
                    </div>

                    <div class="mt-4 grid gap-2">
                        <Label for="field_max_length">Maximale Länge</Label>
                        <Input id="field_max_length" v-model="maxLength" type="number" placeholder="Maximale Länge" min="0" @input="onValueChanged" />
                    </div>
                </div>
                ...
                <div v-if="supportsValueValidation" class="form-section">
                    ...
                    <div class="grid gap-2">
                        ...
                        <Input id="field_min_value" v-model="minValue" type="number" placeholder="Minimalwert" @input="onValueChanged" />
                    </div>
                ...
                <div v-if="supportsFileTypes" class="form-section">
                    ...
                    <div class="grid gap-2">
                        ...
                        />
                        <div class="text-hint">Kommagetrennte Liste von Dateierweiterungen</div>
                    </div>
                </div>
            </form>
                ...
                <div class="options-grid">
                    <div v-for="option in model.options" :key="option.id" class="option-row">
                        <div class="option-inputs">
                            <Input v-model="option.label" placeholder="Bezeichnung" class="option-label" @change="updateOptions" />
                        ...
                        <Button variant="ghost" size="sm" @click="removeOption(option)">
                            <TrashIcon />
                        </Button>
                    </div>
