...
const getLabelForFieldType = (type: FieldType): string => {
  switch (type) {
    case FIELD_TYPES.TEXT: return 'Text (1 Zeile)';
    case FIELD_TYPES.TEXTAREA: return 'Text';
    case FIELD_TYPES.NUMBER: return 'Nummer';
    case FIELD_TYPES.EMAIL: return 'E-Mail';
    case FIELD_TYPES.PHONE: return 'Telefon';
    case FIELD_TYPES.SELECT: return 'Auswahlliste';
    case FIELD_TYPES.RADIO: return 'Radio Buttons';
...
<Card>
  <div class="formbuilder-toolbox">
    ...
    <div class="toolbox-description">
        Klicke auf ein Element, um es zum Formular hinzuzufügen.
    </div>
