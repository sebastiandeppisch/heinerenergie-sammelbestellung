...
function submitForm() {
  const missingRequiredFields = props.formDefinition.fields.filter(field =>
    field.required && !formValues.value[field.id]
  );
...
<template>
  <div class="form-preview">
    ...
    <div class="fields-container">
      <div
        v-for="(field, index) in formDefinition.fields"
        :key="field.id ?? index"
        class="field-wrapper"
      >
        <FormFieldRenderer
