    ...
    <div style="display: flex;">
      <div class="dx-card" style="min-width: 400px;">
        ...
        <div class="dx-field">
          ...
          <div class="dx-field-value-static">{{order.firstName}} {{order.lastName}}</div>
        </div>

        <div class="dx-field">
          <div class="dx-field-label">Adresse</div>
          <div class="dx-field-value-static">{{order.street}} {{order.streetNumber}}<br> {{order.zip}} {{order.city}}</div>
        </div>

        <div class="dx-field">
          <div class="dx-field-label">Kontakt</div>
          <div class="dx-field-value-static">
            <i class="dx-icon-email"></i> {{order.email}} <br>
            <i class="dx-icon-tel"></i> {{order.phone}}
          </div>
        </div>
      </div>
