...
function locateUser() {
    ...
    navigator.geolocation.getCurrentPosition(
        ...
        (position) => {
            ...
            mapRef.value?.leafletObject.setView([position.coords.latitude, position.coords.longitude], 16);
        ...
        <div ref="mapContainerRef" class="map-container">
            ...
            >
                ...
                <LControl position="topright" v-if="!props.readonly">
                    <div>
                        <Button @click.prevent="locateUser" :variant="isLocating ? 'outline' : 'default'" :disabled="isLocating" class="w-60">
