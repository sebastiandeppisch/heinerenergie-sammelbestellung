...
<template>
<SingleCard title="Registierung" description="Herzlich Willkommen in Deiner neuen Ehrenamt-CRM Instanz. Als erstes musst Du einen neuen Administrator Zugang anlegen.">
  <form class="space-y-6" @submit.prevent="onSubmit">
    <div class="space-y-4 gap-2 grid">
