<template>
    <div>
        <PageHeader title="Initiativen-Verwaltung">
            <template v-if="canCreateGroups" #actions>
                ...
                <div class="p-6">
                    <Tabs v-model="selectedTab" @update:model-value="onTabChanged">
                        ...
                        <TabsContent value="beratungsgebiet">
                            <ConsultingAreaForm :group="selectedGroup" :polygon="polygon" :consulting-area-postal-codes="consultingAreaPostalCodes" />
                        </TabsContent>
...
setLayoutProps({
    breadcrumbs: [{ title: 'Initiativen' }, { title: 'Initiativen-Verwaltung' }],
});
