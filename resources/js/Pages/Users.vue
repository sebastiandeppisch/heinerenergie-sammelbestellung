...
setLayoutProps({
    breadcrumbs: [{ title: 'Initiativen' }, { title: 'Berater*innen' }],
});
...
<template>
    <div class="mx-auto w-full max-w-6xl">
        <PageHeader title="Berater*innen" description="Verwalte Berater*innen">
            <template #actions>
                            ...
                            <TableCell>
                                <div class="flex flex-col gap-2">
                                    <div v-for="group in user.groups" :key="group.id" class="flex items-center gap-2">
                                        <img v-if="group.logo_path" :src="group.logo_path" :alt="group.name" class="h-6 w-6 rounded object-cover" />
